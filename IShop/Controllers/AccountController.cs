...
using static IShop.Controllers.ManageController;
...
namespace IShop.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { FirstName = model.FirstName, LastName = model.LastName, UserName = model.Email, Email = model.Email, LockoutEnabled = false };
        ...
        {
            string userId = User.Identity.GetUserId();
            List<Order> orders = db.Orders.Include(o => o.ApplicationUser).Include(o => o.Bill).Include(o => o.DailyMenu).Where(t => t.UserId.Equals(userId)).ToList();
            return View(orders);
        }
        ...
        public ActionResult Bill(int? id)
        {
            ...
            ApplicationUser user = db.Users.Where(d => d.Id == userId).FirstOrDefault();
        ...
        [UserOrManager]
        [HttpPost]
        public ActionResult EditUserProfile(ApplicationUser user)
        {
            if (ModelState.IsValid)
            {
